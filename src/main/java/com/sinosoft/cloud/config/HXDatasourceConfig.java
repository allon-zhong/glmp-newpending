...
@MapperScan(basePackages = "com.sinosoft.cloud.hxDao",  sqlSessionFactoryRef = "sqlSessionFactory2")
public class HXDatasourceConfig {

    @Autowired
    @Qualifier("HXDataSource")
    ...
    public SqlSessionFactory sqlSessionFactory2() throws Exception {
        ...
        factoryBean.setMapperLocations(resolver.getResources("classpath:hxMapper/*.xml"));
